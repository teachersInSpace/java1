...
public static void main(String[] args) {
  ...
  is of <code>ArrayList</code> type? In Java only the values of <strong><em>primitive data
      types</em></strong> (which are <code>int</code>, <code>double</code>, <code>char</code>,
  ...
  variables that are not of primitive data types are of <strong><em>reference data types</em></strong>
...
<p>The type of a certain group of objects is called a <strong>class</strong>. <code>ArrayList</code> is
...
<ul>
  ...
  <li><b>what the state of the objects are, or in other words, what kind of attributes the objects
    have</b></li>
</ul>
...
System.out.println(bartosSwissAccount);
    ...
    <p><b>Note:</b> there is a different exercise template for each of the sub-exercises.
    ...
    the account. <strong>Note!</strong> do all the steps described in the exercise exactly in the
    described order!</p>
...
value: 100
    ...
    <p><strong>Hint</strong>: add to the class a new object variable that remembers the initial
...
public class BoundedCounter {
    ...
    <p><b>Note</b>: you cannot return an integer value directly from the method toString since the
...
public class Main {
    ...
    addition to the definition of main: <code>public static void main(String[] args) <b>throws
        Exception</b> {</code></p>
...
<p><big><b>Important notes regarding the use of objects. You should definately read these.</b></big></p>
...
average: 2.75
    ...
    <p><strong>Note:</strong> you should not make any changes to class NumberStatistics!</p>
...
sum: 15
    ...
    <p><b>NOTE</b>: define in your program <i>three</i> <code>NumberStatistics</code> objects. The
    ...
    <p><b>The tests does not work if you do not create the objects in the order mentioned above!!</b></p>
...
Password: bpqmedlbqaopq
    ...
    <p><b>Tip 1:</b> this is how you turn the integer <tt>number</tt> into a character:</p>
...
char symbol = "abcdefghijklmnopqrstuvwxyz".charAt(number);
    ...
    <p><b>Tip 2:</b> The tip in assignment 58 might be useful in this one too.</p>
  </div>
...
2 9 11 18 23 32 34
    ...
    <p><strong>Note!</strong> a number can be in one set of numbers only once (per draw of
    course).</p>
  </div>
